...
namespace UnitTests
{
    ...
    public class UnitTestsTimeConstructors
    {
        ...
        private void AssertTime(Time t, byte expectedH = 0, byte expectedM = 0, byte expectedS = 0, long expectedMS = 0)
        {
        ...
        [DataRow((byte)0, (byte)0, (byte)0, 0, (byte)0, (byte)0, (byte)0, 0)]
        [DataRow((byte)15, (byte)30, (byte)20, 15, (byte)15, (byte)30, (byte)20, 15)]
        [DataRow((byte)23, (byte)59, (byte)59, 59, (byte)23, (byte)59, (byte)59, 59)]
        public void Constructor_4params_noException(byte h, byte m, byte s, long ms, byte expectedH, byte expectedM, byte expectedS, long expectedMS)
        {
        ...
        [DataTestMethod, TestCategory("Constructors")]
        [DataRow((byte)1, (byte)60, (byte)25, 25)]
        [DataRow((byte)24, (byte)30, (byte)04, 25)]
        [DataRow((byte)11, (byte)1, (byte)60, 25)]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Constructor_4params_ArgumentOutOfRangeException(byte h, byte m, byte s, long ms)
        {
        ...
        [DataTestMethod, TestCategory("Constructors")]
        [DataRow("23:59:59:059", (byte)23, (byte)59, (byte)59, 59)]
        [DataRow("00:00:00:000", (byte)0, (byte)0, (byte)0, 0)]
        [DataRow("02:30:15:001", (byte)2, (byte)30, (byte)15, 1)]
        [DataRow("10:20:05:129", (byte)10, (byte)20, (byte)5, 129)]
        public void Constructor_stringGiven_noException(string s, byte expectedH, byte expectedM, byte expectedS, long expectedMS)
        {
            Time t = new Time(s);
    ...
    public class UnitTestsTimePeriodConstructors
    {
        ...
        public void Constructor_Default()
        {
            ...
            Assert.AreEqual(defaultValue, t.Hours * 3600000 + t.Minutes * 60000 + 1000 * t.Seconds + t.Miliseconds);
        }

        [DataTestMethod, TestCategory("Constructors")]
        [DataRow(0, (byte)0, (byte)0, (byte)0, 0)]
        [DataRow(55820200, (byte)15, (byte)30, (byte)20, 20)]
        [DataRow(86439999, (byte)23, (byte)59, (byte)59, 999)]
        public void Constructor_SecondsGiven_noException(long time, byte expectedH, byte expectedM, byte expectedS, long expectedMS)
        {
            TimePeriod t = new TimePeriod(time);

            Assert.AreEqual(t.Hours * 3600000 + t.Minutes * 60000 + 1000 * t.Seconds + t.Miliseconds, time);
        }
        ...
        [DataTestMethod, TestCategory("Constructors")]
        [DataRow((byte)0, (byte)0, (byte)0, 0, 0)]
        [DataRow((byte)45, (byte)30, (byte)20, 0, 163820000)]
        [DataRow((byte)23, (byte)59, (byte)59, 0, 86399000)]
        public void Constructor_3params_noException(byte h, byte m, byte s, long ms, long expectedMiliseconds)
        {
            TimePeriod t = new TimePeriod(h, m, s, ms);

            Assert.AreEqual(t.Hours * 3600000 + t.Minutes * 60000 + 1000 * t.Seconds + t.Miliseconds, expectedMiliseconds);
        }

        [DataTestMethod, TestCategory("Constructors")]
        [DataRow((byte)0, (byte)60, (byte)0, 0)]
        [DataRow((byte)15, (byte)30, (byte)70, 0)]
        [DataRow((byte)5, (byte)69, (byte)59, 0)]
        [ExpectedException(typeof(ArgumentOutOfRangeException))]
        public void Constructor_3params_Exception(byte h, byte m, byte s, long ms)
        {
            TimePeriod t = new TimePeriod(h, m, s, ms);
        }
        ...
        public void Constructor_2TimeParams_noException()
        {
            ...
            Assert.AreEqual(9, timePeriod.Seconds);
            Assert.AreEqual(960, timePeriod.Miliseconds);
        }
    ...
    public class UnitTestsTimeToString
    {
        ...
        [DataRow((byte)0, (byte)0, (byte)0, 0, "00:00:00:000")]
        [DataRow((byte)2, (byte)30, (byte)15, 15, "02:30:15:015")]
        [DataRow((byte)10, (byte)20, (byte)5, 5, "10:20:05:005")]
        public void Time_ToString_Formattable(byte h, byte m, byte s, long ms, string expectedStringRepresentation)
        {
    ...
    public class UnitTestsTimePeriodOperators
    {
        ...
        public void UnitTests_overloading_Increment()
        {
            ...
            Assert.AreEqual(expectedTime.Hours * 3600000 + expectedTime.Minutes * 60000 + 1000 * expectedTime.Seconds + expectedTime.Miliseconds, t1.Hours * 3600000 + t1.Minutes * 60000 + 1000 * t1.Seconds + t1.Miliseconds + 1);
        }
        [TestMethod, TestCategory("Operators")]
        public void UnitTests_overloading_Decrement()
        {
    ...
    public class UnitTestsTimeComparsionOperators
    {
            ...
            [DataTestMethod]
            [DataRow((byte)0, (byte)0, (byte)0, 0, (byte)0, (byte)0, (byte)0, 0)]
            [DataRow((byte)0, (byte)0, (byte)0, 0, (byte)0, (byte)0, (byte)1, 0)]
            [DataRow((byte)0, (byte)0, (byte)1, 0, (byte)0, (byte)1, (byte)0, 0)]
            public void LessThanOrEqual_Operator_ReturnsTrue(byte h1, byte m1, byte s1, long ms1, byte h2, byte m2, byte s2, long ms2)
            {
            ...
            [TestMethod, TestCategory("ComparsionOperators")]
            [DataTestMethod]
            [DataRow((byte)0, (byte)0, (byte)1, 0, (byte)0, (byte)0, (byte)0, 0)]
            [DataRow((byte)0, (byte)1, (byte)0, 0, (byte)0, (byte)0, (byte)0, 0)]
            [DataRow((byte)1, (byte)0, (byte)0, 0, (byte)0, (byte)0, (byte)0, 0)]
            public void GreaterThan_Operator_ReturnsTrue(byte h1, byte m1, byte s1, long ms1, byte h2, byte m2, byte s2, long ms2)
            {
                var t1 = new Time(h1, m1, s1, ms1);
                var t2 = new Time(h2, m2, s2, ms2);
            ...
            [DataRow((byte)0, (byte)0, (byte)1, 0, (byte)0, (byte)0, (byte)0, 0)]
            [DataRow((byte)0, (byte)1, (byte)0, 0, (byte)0, (byte)0, (byte)0, 0)]
            public void GreaterThanOrEqual_Operator_ReturnsTrue(byte h1, byte m1, byte s1, long ms1, byte h2, byte m2, byte s2, long ms2)
            {
                var t1 = new Time(h1, m1, s1, ms1);
                var t2 = new Time(h2, m2, s2, ms2);
