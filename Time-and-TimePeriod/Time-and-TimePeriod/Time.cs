...
namespace TimeAndTimePeriod
{
    ...
    public readonly struct Time : IEquatable<Time>, IComparable<Time>
    {
        ...
        /// <summary>
        /// Creates default instance of the Time class with the zero hours, minutes and seconds.
        /// </summary>
        public Time()
        {
            Hours = 00;
        ...
        public static Time Plus(Time t, TimePeriod tp) => new(t.Hours * 3600 + t.Minutes * 60 + t.Seconds + tp.Hours * 3600 + tp.Minutes * 60 + tp.Seconds);
        public Time Plus(Time t) => Plus(this, t);
        public Time Plus(TimePeriod tp) => Plus(this, tp);

        public static Time Minus(Time t, TimePeriod tp) => new((t.Hours * 3600 + t.Minutes * 60 + t.Seconds) - tp.Hours * 3600 + tp.Minutes * 60 + tp.Seconds);
